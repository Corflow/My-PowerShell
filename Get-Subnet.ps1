...
<#  
    ...
    .EXAMPLE
    PS C:\> $result | where {$_.Active -eq $true}| Format-Table IP, Host, OS_Name -AutoSize

    IP        Host            OS_Name                                                
    --        ----            -------                                                
    10.4.1.50 BNA-PR-DAH01                                                           
    10.4.1.52 BNA-PR-IT-FIN01 Microsoft(R) Windows(R) Server 2003, Enterprise Edition
    10.4.1.66 BNA-PR-SP-CTX02                                                        
    10.4.1.70 BNA-ACT1        Microsoft(R) Windows(R) Server 2003, Standard Edition 

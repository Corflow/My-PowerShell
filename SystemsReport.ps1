...
$users = "steve.ross@PremiseHealth.com" # List of users to email your report to (separate by comma)
$fromemail = "Reports@PremiseHealth.com"
$server = "Relay.PremiseHealth.com" #enter your own SMTP server DNS name / IP address here
